(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Alc"] = factory(require("lodash/filter"), require("lodash/map"), require("react"), require("prop-types"), require("classnames"), require("react-autosuggest"), require("locale-currency"), require("country-code"), require("flag-icon-css/css/flag-icon.css"), require("debug"));
	else
		root["Alc"] = factory(root["lodash/filter"], root["lodash/map"], root["react"], root["prop-types"], root["classnames"], root["react-autosuggest"], root["locale-currency"], root["country-code"], root["flag-icon-css/css/flag-icon.css"], root["debug"]);
